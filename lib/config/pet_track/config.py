...
cfg.MODEL.REDETECT.LOCALIZATION_THRESHOLD = 0.50
...
# Lightweight visibility controller and recovery hypothesis lifecycle.
...
cfg.MODEL.SRBT.CONTROLLER.THETA_PRESENT = 0.70
cfg.MODEL.SRBT.CONTROLLER.THETA_RECOVER = 0.75
cfg.MODEL.SRBT.CONTROLLER.SUSPECT_FRAMES = 2
cfg.MODEL.SRBT.CONTROLLER.ABSENT_FRAMES = 4
cfg.MODEL.SRBT.CONTROLLER.VERIFY_FRAMES = 2
