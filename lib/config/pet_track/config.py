...
cfg.MODEL.SRBT.BELIEF = edict()
cfg.MODEL.SRBT.BELIEF.STATE_DIM = 32
cfg.MODEL.SRBT.BELIEF.QUALITY_DIM = 16
cfg.MODEL.SRBT.BELIEF.HIDDEN_DIM = 128
cfg.MODEL.SRBT.BELIEF.MAX_HAZARD = 128
cfg.MODEL.SRBT.BELIEF.REAPPEARING_MAX_FRAMES = 3
...
cfg.MODEL.SRBT.CONTROLLER.THETA_TRACK = 0.70
cfg.MODEL.SRBT.CONTROLLER.THETA_ENTROPY = 0.35
cfg.MODEL.SRBT.CONTROLLER.THETA_IDENTITY = 0.60
cfg.MODEL.SRBT.CONTROLLER.THETA_MOTION = 0.50
cfg.MODEL.SRBT.CONTROLLER.THETA_ABSENT = 0.60
cfg.MODEL.SRBT.CONTROLLER.THETA_HAZARD8 = 0.30
cfg.MODEL.SRBT.CONTROLLER.REDETECT_AGE = 5
...
cfg.MODEL.SRBT.TEACHER.ENCODE_CHUNK_SIZE = 2
