...
cfg.MODEL.EXPERT.COLLABORATION_HIDDEN_DIM = 32
cfg.MODEL.EXPERT.COLLABORATION_TRAINED = False
...
cfg.MODEL.REDETECT.EVENT_DENSITY_KERNEL_SIZE = 25
cfg.MODEL.REDETECT.EVENT_PROPOSAL_INFERENCE = False
